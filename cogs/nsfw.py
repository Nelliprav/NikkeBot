...
class nsfw(commands.Cog):
    ...
    async def waifu(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            pat.set_footer(text="Nikke Bot © 2022 Все права защищены")
    ...
    async def blowjob(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            blowjob.set_footer(text="Nikke Bot © 2022 Все права защищены")
    ...
    async def trap(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            trap.set_footer(text="Nikke Bot © 2022 Все права защищены")
    ...
    async def neko(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            neko.set_footer(text="Nikke Bot © 2022 Все права защищены")
    ...
    async def sex(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            sex.set_footer(text="Nikke Bot © 2022 Все права защищены")
    ...
    async def solo(self, ctx):
        if ctx.channel.is_nsfw():
            ...
            solo.set_footer(text="Nikke Bot © 2022 Все права защищены")
